...
NEED_IMPL bool __impl_dvr_timer_enable(uint16_t autoreload, CallbackFn fn);
...
__STATIC_FORCEINLINE bool dvr_timer_enable(uint16_t autoreload, CallbackFn fn) { return __impl_dvr_timer_enable(autoreload, fn); }
